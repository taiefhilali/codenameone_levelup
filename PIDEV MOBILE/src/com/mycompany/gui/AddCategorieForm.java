...
import static com.mycompany.gui.CategoryAdminForm.nomCategorie;
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (nomCat.getText().equals("")) {
                    Dialog.show("Erreur", "Veuillez remplir touts les champs ", "Annuler", "Accepter");
                } else {
                    Dialog.show("Alerte de Confirmation ", "Confirmer le choix?", "Oui", "Non");
                    boolean state = ServiceCategorie.getInstance().modifierCategorie(nomCat.getText(), ((int) caf.nomCategorie.getId_categorie()));
